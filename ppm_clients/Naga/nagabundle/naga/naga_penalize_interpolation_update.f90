...
!
!
! This routines performs interpolation penalization, cf Rasmussen:2011 using
! update of the vorticity field and not a replacement with FD curl values
! The order of the FD stencil is set in the variable 'penalizationscheme'
!------------------------------------------------------------------------------

MODULE naga_mod_penalize_interpolation_update

IMPLICIT NONE

INTERFACE naga_penalize_interpolation_update
  MODULE PROCEDURE naga_penalize_interpolation_update
END INTERFACE

CONTAINS

SUBROUTINE naga_penalize_interpolation_update(info)
...
END SUBROUTINE naga_penalize_interpolation_update

END MODULE naga_mod_penalize_interpolation_update
