...
INTERFACE naga_extrapolate
  ...
  END INTERFACE
  CONTAINS
SUBROUTINE naga_extrapolate_s(pset,field,nextra,nbase,info)
...
RETURN
END SUBROUTINE naga_extrapolate_s
SUBROUTINE naga_extrapolate_v(pset,field,nextra,nbase,info)
USE naga_mod_globals
USE naga_mod_say
USE ppm_module_topo_get
IMPLICIT NONE
...
CALL substop('ppm_poisson_extrapolateghost',t0,info)
RETURN
END SUBROUTINE naga_extrapolate_v
