...
#include "ppm_fft_plan_3d_vec_fc2c_z.f"
#include "ppm_fft_plan_3d_vec_fr2c_xy.f"
      !BACKWARD TRANSFORMS - PLAN
#include "ppm_fft_plan_3d_vec_bc2c_z.f"
#include "ppm_fft_plan_3d_vec_bc2r_xy.f"
!#include "ppm_fft_plan_3d_vec_bc2c_xy.f"
      !EXECUTION OF PLANS
#include "ppm_fft_exec_3d_vec_c2c_z.f"
#include "ppm_fft_exec_3d_vec_fr2c_xy.f"
#include "ppm_fft_exec_3d_vec_bc2r_xy.f"
!#include "ppm_fft_exec_3d_vec_bc2c_xy.f"
      !NORMALIZATION
#include "ppm_fft_normalize_r.f"
#include "ppm_fft_normalize_c.f"
